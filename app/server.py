...
def student():
    ...
    insertQuery = "INSERT INTO Student (goal, level, min_pay, max_pay, lesson_num, remark) VALUES (?, ?, ?, ?, ?, ?);"
    con.execute(insertQuery, (target, exp, min_pay, max_pay, numperweek, remarks))
    con.commit()
